 ...
 */
$config['site_title']                 = "Cupim Dourado";       // Site Title, example.com This is not more functional
$config['admin_email']                = "vendas@rfsystem"; // Admin Email, admin@example.com This is not more functional
