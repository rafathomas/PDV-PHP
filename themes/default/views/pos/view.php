...
<?php } ?>
    ...
    <?php if (!$Settings->java_applet) { ?>
        ...
        <div class="col-xs-12" style="background:#F5F5F5; padding:10px;">
            ...
            <p style="text-transform: capitalize;"><strong>Chrome:</strong> Menu &gt; Impressora &gt; Desabilitar Cabeçalho/Rodapé Opções &amp; Setar margem em branco</p></div>
            <font>
    <?php } ?>
    <div style="clear:both;"></div>
